...
class UserProfileRequest extends FormRequest
{
    ...
    {
        return [
            'name' => ['required', 'min:2', 'max:100', 'unique:App\Models\User,name,'.auth()->user()->id],
            'email' => ['required', 'email', 'min:8', 'max:100', 'unique:App\Models\User,email,'.auth()->user()->id],
    ...
    {
        return $this->userService->conditionalPassword($this);
    }
}
