                                                        ...
                                                        <div class="col-10">
                                                            <div class="form-group has-icon-left">
                                                                ...
                                                                <div class="position-relative">
                                                                    <input type="text" class="form-control form-control-xl" v-model="client_category.logo" name="logo" placeholder="Logo" id="logo" readonly />
                                            ...
                                            <div class="col-12">
                                                <validation-provider name="category_name" rules="required|min:3|max:100" v-slot="{ dirty, valid, invalid, errors }">
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control form-control-xl" v-model="client_category.category_name" name="category_name" placeholder="Category Name" id="category_name" />
                                                            <div class="form-control-icon">
                                                                <i class="bi bi-tag"></i>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-12">
                                                <validation-provider name="slug" rules="min:3|max:200" v-slot="{ dirty, valid, invalid, errors }">
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control form-control-xl" v-model="client_category.slug" name="slug" placeholder="Slug" id="slug">
                                                            <div class="form-control-icon">
                                                                <i class="bi bi-map"></i>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-12">
                                                <validation-provider name="order" rules="required|numeric" v-slot="{ dirty, valid, invalid, errors }">
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control form-control-xl" v-model="client_category.order" name="order" placeholder="Order" id="order" />
                                                            <div class="form-control-icon">
        ...
        <section class="section">
            <div class="row match-height">
                <div class="offset-md-3 col-md-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">List of Client Categories</h3>
                        </div>
                        <div class="card-body">
                            <data-table ref="tableClientCategories" class="table-default" :columns="table.columns"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                table: {
                    ...
                    url: '/api/admin/client-categories',
                    classes: {
                        "table-container": {
        ...
        methods: {
            reloadDatatable() {
                this.$refs.tableClientCategories.getData();
            },
            ...
            editHandler(params) {
                this.$store.dispatch('clientCategoryShow', params).then( (resp)=> {
                    console.log('clientCategoryShow request success!');
                    this.serverResp = resp.data;
                    this.client_category = resp.data.data;
                }).catch(err => {
            ...
            deleteHandler(params) {
                return this.$store.dispatch('clientCategoryDestroy', params).then( (resp)=> {
                    console.log('clientCategoryDestroy request success!');
                    this.serverResp = resp.data;
                    this.reloadDatatable();
                    this.initClientCategory();
                    return resp;
                }).catch(err => {
                    this.serverResp = err.response.data;
                    this.$refs.form.setErrors(err.response.data.errors);
            ...
            setByField(fileUrl, elem) {
                if(elem==='logo') {
                    this.client_category.logo = fileUrl;
                }
            },

            save() {
                let params = this.client_category;

                if(params.id===null) {
                    this.$store.dispatch('clientCategoryStore', params).then( (resp)=> {
                        console.log('clientCategoryStore request success!');
                        this.serverResp = resp.data;
                        this.reloadDatatable();
                        this.initClientCategory();
                    }).catch(err => {
                    ...
                    this.$store.dispatch('clientCategoryUpdate', params).then( (resp)=> {
                        console.log('clientCategoryUpdate request success!');
                        this.serverResp = resp.data;
                        this.reloadDatatable();
                        this.initClientCategory();
                    }).catch(err => {
