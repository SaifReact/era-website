                                                        ...
                                                        <div class="col-10">
                                                            <div class="form-group has-icon-left">
                                                                ...
                                                                <div class="position-relative">
                                                                    <input type="text" class="form-control form-control-xl" v-model="about_us.image" name="image" placeholder="Image" id="image" readonly />
                                            ...
                                            <div class="col-12">
                                                <validation-provider name="title" rules="required|min:3|max:100" v-slot="{ dirty, valid, invalid, errors }">
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control form-control-xl" v-model="about_us.title" name="title" placeholder="Title" id="title" />
                                                            <div class="form-control-icon">
                                            ...
                                            <div class="col-12">
                                                <validation-provider name="summary" rules="required|min:3|max:1000" v-slot="{ dirty, valid, invalid, errors }">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control form-control-xl" v-model="about_us.summary" name="summary" id="summary" rows="3"></textarea>
                                                        <div class="form-control-feedback" :style="fieldErrorPlaceholder">{{ errors[0] }}</div>
                                                    </div>
                                                </validation-provider>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <validation-provider name="url" rules="min:14|max:200|url" v-slot="{ dirty, valid, invalid, errors }">
                                                    <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="position-relative">
                                                            <input type="text" class="form-control form-control-xl" v-model="about_us.url" name="url" placeholder="URL" id="url">
                                                            <div class="form-control-icon">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            fetchAboutUs() {
                this.$store.dispatch('aboutUsShow').then( (resp)=> {
                    console.log('aboutUsShow request success!');
                    this.about_us = resp.data.data;
                }).catch( err => {
            ...
            setByField(fileUrl, elem) {
                if(elem==='image') {
                    this.about_us.image = fileUrl;
                }
            },

            save() {
                let params = this.about_us;

                this.$store.dispatch('aboutUsUpdate', params).then( (resp)=> {
                    console.log('aboutUsUpdate request success!');
