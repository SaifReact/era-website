...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            fetchCompanyInfo() {
                this.$store.dispatch('companyInfoShow').then( (resp)=> {
                    console.log('companyInfoShow request success!');
            ...
            save() {
                ...
                this.$store.dispatch('companyInfoUpdate', params).then( (resp)=> {
                    console.log('companyInfoUpdate request success!');
